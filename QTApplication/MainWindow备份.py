...
class Ui_MainWindow(QtWidgets.QMainWindow):
    def setupUi(self, MainWindow):
        ...
        self.menubar.triggered['QAction*'].connect(MainWindow.open_directory)  # type: ignore
        self.treeView.clicked['QModelIndex'].connect(MainWindow.on_tree_item_clicked)  # type: ignore
        self.treeWidget_1.clicked['QModelIndex'].connect(MainWindow.variable_choose)  # type: ignore
        self.pushButton.clicked.connect(MainWindow.run_cmd)  # type: ignore
        self.treeWidget_1.clicked['QModelIndex'].connect(MainWindow.right_tree_clicked)  # type: ignore
